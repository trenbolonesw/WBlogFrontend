    ...
    return(
        <div className="Dashboard-layout">
            ...
            <div className="dashboard">
                {auth.isLoggedIn && <div className="dashboard-blocks">blog count<p className="blogNumber">{blogNumber}</p></div>}
                {auth.isLoggedIn && <div className="dashboard-blocks">Gallary Photo Count <p className="blogNumber">{GalleryPhotos}</p></div>}
